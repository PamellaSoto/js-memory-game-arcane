...
function createCards() {
    const cardImages = [
        ["../src/images/cards/caitlyn.png", "cait"],
        ["../src/images/cards/caitlyn.png", "cait"],
        ["../src/images/cards/ekko.png", "ekko"],
        ["../src/images/cards/ekko.png", "ekko"],
        ["../src/images/cards/jayce.png", "jayce"],
        ["../src/images/cards/jayce.png", "jayce"],
        ["../src/images/cards/jinx.png", "jinx"],
        ["../src/images/cards/jinx.png", "jinx"],
        ["../src/images/cards/mel.png", "mel"],
        ["../src/images/cards/mel.png", "mel"],
        ["../src/images/cards/viktor.png", "viktor"],
        ["../src/images/cards/viktor.png", "viktor"],
        ["../src/images/cards/vi.png", "vi"],
        ["../src/images/cards/vi.png", "vi"],
        ["../src/images/cards/poro.png", "poro"],
        ["../src/images/cards/poro.png", "poro"]
    ];
